...
let viewSettings = JSON.parse(localStorage.getItem('kana_view')) || {
    ...
    flashSpeed: 'normal', flashManual: false
};
...
function updateUI() {
    ...
    // 체크박스 상태 업데이트
    const checkMap = {
        'chk-fav': viewSettings.onlyBookmark, 'chk-ko': viewSettings.showKo, 'chk-ruby': viewSettings.showRuby,
        'chk-playclick': viewSettings.playOnClick, 'chk-playflash': viewSettings.playOnFlash,
